...
# 0. Sample Disclaimer
  * This set of analyses on interrupted healthcare is based on responses collected from 4,769 caregivers between the dates of April 6th 2020 and December 23rd 2020. These caregivers represent a range of voices: 6.90% are non-Latinx Black/African American, 14.10% are Latinx, and 28.58% live at or below 1.5 times the federal poverty line.  Proportions/percentages are calculated based on the item-level response rates, not out of the total sample size. The data for these analyses are not weighted. \
