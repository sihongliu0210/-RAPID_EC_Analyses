...
# 0. Sample Disclaimer
  * This set of analyses on stimulus spending is based on responses collected from 3,860 caregivers between the dates of September 21st, 2020 and March 19th, 2021. These caregivers represent a range of voices: 7.00% are Black/African American, 12.52% are Latinx, and 26.57% live at or below 1.5 times the federal poverty line.  Proportions/percentages are calculated based on the item-level response rates, not out of the total sample size. The data for these analyses are not weighted. \
