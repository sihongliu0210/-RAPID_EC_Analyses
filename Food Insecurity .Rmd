...
```{r, echo=FALSE, message = FALSE, warning = FALSE}
#Sample Disclaimer:
#These analyses are based on responses collected from 2684 caregivers between the dates of August 10th 2020 and November 5th 2020. These caregivers represent a range of voices: 7.71% are Black/African American, 15.95% are LatinX, and 26.19% live at or below 1.5 times the federal poverty line. Proportions/percentages are calculated based on the item-level response rates, not out of the total sample size. The data for these analyses are not weighted.
