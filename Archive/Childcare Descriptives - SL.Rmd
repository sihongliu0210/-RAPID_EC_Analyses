...
### Total Responses Breakdown by Income
...
### Total Responses Breakdown by Race/Ethnicity
...
### Total Responses Breakdown by Caregivers' Employment Status
...
### Total Responses Breakdown by Material Hardship Status - Post-COVID
  *Note. No data assessing pre-COVID material harship. Thus, data below present the usage of non-parental childcare breakdown by material hardship status only during right after COVID and current situations.
...
## Map Out Changes of Percentage of Non-Parental Childcare Over Time
...
### Changes of Percentage of Non-Parental Childcare Over Time - Breakdown by Caregivers' Employment Status
...
### Changes of Percentage of Non-Parental Childcare Over Time - Breakdown by Material Hardship Status
...
### Responses Breakdown by Caregivers' Employment Status
```{r, echo=FALSE, message = FALSE}
cc_np_pre <- ccare %>%
  filter (Week == 0 ) %>%
  group_by (work_status)%>%
...
### Responses Breakdown by Material Hardship Status
